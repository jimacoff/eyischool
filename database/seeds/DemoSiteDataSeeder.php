...
class DemoSiteDataSeeder extends Seeder
{
    ...
    private function contactData()
    {
        ...
        SiteMeta::updateOrCreate(
            ...
            [ 'meta_value' => 'Off Bisi Ajayi Street, Agunbelewo hill, Osogbo, Osun State']
        );
        SiteMeta::updateOrCreate(
            ['meta_key' => 'contact_phone'],
            [ 'meta_value' => '+2348033867177']
        );
        SiteMeta::updateOrCreate(
            ['meta_key' => 'contact_email'],
            [ 'meta_value' => 'eyitayoschool@gmai.com']
        );
        SiteMeta::updateOrCreate(
    ...
    private function aboutSectionData()
    {
        ...
        $data = [
            ...
            'key_point_1_content' => 'Eyitayo School has come a long way since inception on February, 2011. Our students are presented with the unique opportunities to grow in confidence, to develop their own personalities in a secure, happy environment where they are nurtured to aim high and to expect great things. Though the school is already known for hard work, concern is still shown for the individuality and uniqueness of each child, striving to achieve the highest academic standard of which they are capable.
...
All students are required to abide by a code of behaviour similar to that normally expected within a family where emphasis is given to courtesy, politeness, integrity, respect and very importantly the fear of God.',
    ...
    private function sliderData()
    {
        ...
        $data = [
            'title' => 'Beautifull Laboratory',
            'subtitle' => 'Welcome to Eyitayo School',
            'order' => 1
        ];
